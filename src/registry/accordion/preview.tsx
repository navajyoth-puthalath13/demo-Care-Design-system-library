    ...
    <>
      <Accordion type="single" collapsible className="w-full max-w-md">
        <AccordionItem value="item-1">
          <AccordionTrigger>What is Care Design?</AccordionTrigger>
          <AccordionContent>
            Care Design is your internal design system built on top of shadcn/ui.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger>How do I use these components?</AccordionTrigger>
          <AccordionContent>
            Install components with the CLI, then browse their API and examples in this registry.
          </AccordionContent>
        </AccordionItem>
      </Accordion>
